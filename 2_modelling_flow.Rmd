...
cq_w_logs <- cq %>% 
  ...
  mutate(across(-gauge_id, ~log(.+1))) %>%  #Log-transform everything but gauge_id
...
# p_mean and p_mean_squared are correlated... I thought about centered them but decided I didn't know enough about that.
